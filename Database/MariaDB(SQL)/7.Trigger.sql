...
insert into users(name,email,birthdate) values("Thapa","thapa@gmail.com",Curdate()) ;
insert into users(name,email) values("Asmita","Asmita@gmail.com");
...
update sales
set quantity = 300 where product = "iphone";
